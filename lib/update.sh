...
UPD_KEEP_LOADED=1   # 1 when the plugin has a keepLoaded panel (needs a shell restart)
...
post_update() {
  # Running agent sessions keep their tmux servers; nothing to restart here.
  :
}
# ------------------------------------------------------------------------------
